...
public class MaskingArrayAdapter extends ArrayAdapter<MaskingRequest> {
  private final int itemLayout;

  public MaskingArrayAdapter(Context context, List<MaskingRequest> items) {
    this(context, items, android.R.layout.simple_list_item_1);
  }

  public MaskingArrayAdapter(Context context, List<MaskingRequest> items, int itemLayout) {
    super(context, itemLayout, items);
    this.itemLayout = itemLayout;
  }

  public static MaskingArrayAdapter fromStrings(Context context, List<String> values,
                                                MaskingType type) {
    ...
    return new MaskingArrayAdapter(context, items);
  }
