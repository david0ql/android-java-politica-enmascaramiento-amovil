...
public class MaskingToggleButton extends AppCompatToggleButton {
  private final MaskingTextConfig config = new MaskingTextConfig();
  private boolean isApplying;

  public MaskingToggleButton(Context context) {
    super(context);
    init(null);
  }

  public MaskingToggleButton(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(attrs);
  }

  public MaskingToggleButton(Context context, AttributeSet attrs, int defStyleAttr) {
