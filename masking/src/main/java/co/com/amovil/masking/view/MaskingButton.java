...
public class MaskingButton extends AppCompatButton {
  private final MaskingTextConfig config = new MaskingTextConfig();
  private boolean isApplying;

  public MaskingButton(Context context) {
    super(context);
    init(null);
  }

  public MaskingButton(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(attrs);
  }

  public MaskingButton(Context context, AttributeSet attrs, int defStyleAttr) {
