...
public class MaskingMultiAutoCompleteTextView extends AppCompatMultiAutoCompleteTextView {
  private final MaskingTextConfig config = new MaskingTextConfig();
  private boolean isApplying;

  public MaskingMultiAutoCompleteTextView(Context context) {
    super(context);
    init(null);
  }

  public MaskingMultiAutoCompleteTextView(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(attrs);
  }

  public MaskingMultiAutoCompleteTextView(Context context, AttributeSet attrs, int defStyleAttr) {
