...
public class MaskingCheckBox extends AppCompatCheckBox {
  private final MaskingTextConfig config = new MaskingTextConfig();
  private boolean isApplying;

  public MaskingCheckBox(Context context) {
    super(context);
    init(null);
  }

  public MaskingCheckBox(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(attrs);
  }

  public MaskingCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
