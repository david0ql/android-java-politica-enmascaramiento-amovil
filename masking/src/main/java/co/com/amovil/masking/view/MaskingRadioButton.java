...
public class MaskingRadioButton extends AppCompatRadioButton {
  private final MaskingTextConfig config = new MaskingTextConfig();
  private boolean isApplying;

  public MaskingRadioButton(Context context) {
    super(context);
    init(null);
  }

  public MaskingRadioButton(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(attrs);
  }

  public MaskingRadioButton(Context context, AttributeSet attrs, int defStyleAttr) {
